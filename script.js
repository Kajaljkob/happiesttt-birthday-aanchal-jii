...
new TypeIt("#teks1", {
   strings: [
  "Happiest Birthday, Aanchal! 🎉",
  "From Class 6th, when we didn’t even talk to each other…",
  "to Class 11th, when we suddenly became best friends — life really said 'plot twist!' 😂",
  "We literally spent years acting like strangers for no reason.",
  "Imagine the memories we could have made if we weren’t so busy ignoring each other.",
  "But I’m glad destiny fixed our story at the right time.",
  "Now we share laughter, secrets, and unlimited random talks.",
  "May this year bring you success, happiness, and lots of reasons to smile.",
  "Stay the same funny, strong, and slightly dramatic girl I know. 💛",
...
new TypeIt("#teks2", {
   strings: [
    "With or without me, may the universe always find a way to make you happy.",
    " ",
